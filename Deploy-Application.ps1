...
Try {
	...
	[string]$appVersion = 'Concurrent -> Named'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '04/13/2021'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'ArcGISPro' -CheckDiskSpace -PersistPrompt
		...
		$regPath = "HKLM:\SOFTWARE\ESRI\ArcGISPro\Licensing"
        $settingPath = "HKLM:\SOFTWARE\ESRI\ArcGISPro\Settings"

		Set-ItemProperty -Path $regPath -Name ARCPRO_AUTH_TYPE -Value ''
		Set-ItemProperty -Path $regPath -Name AUTHORIZATION_TYPE -Value NAMED_USER
		Set-ItemProperty -Path $regPath -Name LICENSE_SERVER -Value '@Not_Set'
		Set-ItemProperty -Path $regPath -Name LOCK_AUTH_SETTINGS -Value ''
		Set-ItemProperty -Path $regPath -Name SEAT_PREFERENCE -Value ''
		Set-ItemProperty -Path $regPath -Name SOFTWARE_TYPE -Value ''
        Set-ItemProperty -Path $settingPath -Name Portal_List -Value 'https://msudenver.maps.arcgis.com'
        Set-ItemProperty -Path $settingPath -Name License_URL -Value 'https://msudenver.maps.arcgis.com'
        Set-ItemProperty -Path $settingPath -Name CheckForUpdatesAtStartup -Value '0'



        [scriptblock]$HKCURegistrySettings = {
            Remove-RegistryKey -Key 'HKCU\Software\ESRI' -Recurse -SID $UserProfile.SID
            }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAQEfFLF4WURcEV
# oBumNnwZhASDLzi9NO2Sy2RpupETZqCCC6EwggWuMIIElqADAgECAhAHA3HRD3la
...
# BgkqhkiG9w0BCQQxIgQg9WQUXdIjspta0wgAHWLGss8nvQmNyr2R/PUljWvOuBcw
# DQYJKoZIhvcNAQEBBQAEggEAiyjHAys8JesIlO0cEgPW/PBrJB/wM1aHLxScNz5d
# qE9dLE4fnhZNboe0VrzFNvwdBpovdOou1S6CZG4Mt1zm4C6h6hnX6EoSzG+UAKcS
# tBSqJ07bvRpXzYT9k/z2n4a+jLiKiiI8Lc3vCQzGL3Wqis07z2Zzjc401ldbuI8D
# 5bjV45Kw4ulIHTD2O/nzIFtb9iSwb4Ge003jXQRJok69Xlni0gYy8MiK+2rZ9TGU
# +9OhdhHjUBOvUuuVPTaW10KYDZ/mo70FSSME6kRtGnlEWn/KgAHqL0X3eBoAIlQc
# fQ6ciPjlgqBzy1w1AX9qheA9EuB2tnpAiTNoRAAoki/EHQ==
